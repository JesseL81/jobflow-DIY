                            ...
                            <div key={item.id} className={`flex flex-col sm:flex-row sm:items-center justify-between p-3 border rounded-lg gap-3 transition-colors ${rowStyle}`}>
                              ...
                              <div className="flex items-center gap-1.5 self-end sm:self-auto shrink-0">
                                <Button 
                                  ...
                                  className="h-8 px-4 bg-blue-600 hover:bg-blue-500 text-white font-bold text-[11px] rounded-md shadow-sm"
                                >
                                  Edit
                                </Button>
                              </div>
                  ...
                  <div className="w-full">
                    {isLinked ? (
                      ...
                      <Input 
                        ...
                        className="flex w-full h-10 rounded-md border border-slate-200 bg-white px-3 text-sm shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                      />
                    )}
                  </div>
